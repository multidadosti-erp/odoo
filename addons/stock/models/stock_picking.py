...
class PickingType(models.Model):
    ...
    show_reserved = fields.Boolean(
        'Show Reserved', default=False, help="If this checkbox is ticked, Odoo will show which products are reserved (lot/serial number, source location, source package).")
