...
# --000000000000a47519057e029630--
# """
#         crm_lead0_id = self.env['mail.thread'].sudo().message_process('crm.lead', new_message0)
#         crm_lead1_id = self.env['mail.thread'].sudo().message_process('crm.lead', new_message1)
#
